...
execute "source ~/.vim/settings.vim"
execute "source ~/.vim/mappings.vim"

command! Esettings execute "e ~/.vim/settings.vim"
command! Emappings execute "e ~/.vim/mappings.vim"
...
" let g:ale_java_eclipselsp_workspace_path=expand('~/java/aleworkspace')
" let g:ale_java_eclipselsp_path=expand('~/projects/eclipse.jdt.ls')
...
let g:syntastic_java_checkstyle_classpath=expand('~/java/checkstyle-8.18-all.jar')
let g:syntastic_java_checkstyle_conf_file = expand('~/java/checkstyle.xml')
